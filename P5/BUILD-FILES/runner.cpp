...
int main() {
    // set_stack_size((int)6e7);
    FastIO::Reader cin;
    FastIO::Writer cout;
    int n = cin.readInt();
    vector<int> cost = cin.readIntArray(n);
    vector<int> bundle = cin.readIntArray(n - 1);
    cout.printArray(Purchases(cost, bundle));
}
